...
const SGCONFIG = "/Users/balint.fulop/Work2/astGrep/ast-grep-playground/sgconfig.yml"
...
export const findDefinition = tool({
  ...
  args: {
    symbol: tool.schema.string().min(1).describe("Symbol identifier to search for"),
    root: tool.schema.string().optional().describe("Repository root (defaults to ~/Work/pulsar)"),
  },
